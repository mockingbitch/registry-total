...
<head>
    ...
    <!--     Fonts and icons     -->
    <link href="{{asset('dashboard/assets/css/font.css')}}" rel="stylesheet" />
    <!-- Nucleo Icons -->
    ...
    <!-- Font Awesome Icons -->
    <script src="{{asset('dashboard/assets/js/kit-fontawesome.js')}}" crossorigin="anonymous"></script>
    <link href="{{asset('dashboard/assets/css/nucleo-svg.css')}}" rel="stylesheet" />
    <!-- CSS Files -->
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
        ...
        <a class="navbar-brand m-0" href="" target="_blank">
            <img src="https://static.vecteezy.com/system/resources/previews/000/623/239/original/auto-car-logo-template-vector-icon.jpg" class="navbar-brand-img h-100" alt="main_logo">
            <span class="ms-1 font-weight-bold">Registry car</span>
        </a>
        </div>
        ...
        <ul class="navbar-nav">
            <li class="nav-item">
            <a class="nav-link {{$breadcrumb === 'Dashboard' ? 'active' : ''}}" href="{{route('home')}}">
            ...
            <li class="nav-item">
                <a class="nav-link {{$breadcrumb === 'TrungTam' ? 'active' : ''}}" href="{{route('trung-tam.list')}}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <span class="nav-link-text ms-1">Trung tâm</span>
                </a>
            </li>
            <li class="nav-item">
            <a class="nav-link {{$breadcrumb === 'Xe' ? 'active' : ''}}" href="{{route('xe.list')}}">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <span class="nav-link-text ms-1">Quản lý xe</span>
            </a>
            </li>
            <li class="nav-item">
            <a class="nav-link {{$breadcrumb === 'NguoiDung' ? 'active' : ''}}" href="{{route('user.list')}}">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
            ...
            <ul class="navbar-nav  justify-content-end">
                ...
                <a class="btn btn-outline-primary btn-sm mb-0 me-3" target="" href="#">{{__('home_page')}}</a>
                </li>
                {{-- drop down logout  --}}
        ...
        <footer class="footer pt-3  ">
            ...
            <div class="row align-items-center justify-content-lg-between">
                ...
                <div class="copyright text-center text-sm text-muted text-lg-start">
                    ...
                    Copyright - Registry Car
                </div>
                </div>
                <div class="col-lg-6">
                <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                    <li class="nav-item">
                    <a href="" class="nav-link text-muted" target="_blank">Registry Car</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="fixed-plugin">
        ...
        <div class="card-body pt-sm-3 pt-0">
            ...
            <div class="d-flex">
            <a class="btn bg-gradient-primary w-100 px-3 mb-2 active" href="#" data-class="bg-transparent">{{__('lang_vi')}}</a>
            <a class="btn bg-gradient-primary w-100 px-3 mb-2 ms-2" href="#" data-class="bg-white">{{__('lang_en')}}</a>
            </div>
            ...
            <a class="github-button" href="https://github.com/mockingbitch" data-icon="octicon-star" data-size="large" data-show-count="true" aria-label="Star creativetimofficial/soft-ui-dashboard on GitHub">Star</a>
